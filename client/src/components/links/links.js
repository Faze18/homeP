        ...
        <div id="box3" className="w3-card w3-round w3-white w3-hide-small">
            <div className="w3-container">
                ...
                <p>
                    ...
                    <a  style={{ width:100+"%"}} target="_blank"  className="w3-tag w3-small w3-theme-d3">New Link Title<input style={{width:80+"%"}}></input></a>
                    <a  style={{ width:100+"%"}} target="_blank"  className="w3-tag w3-small w3-theme-d3">New Link Address<input style={{width:80+"%"}}></input></a>
