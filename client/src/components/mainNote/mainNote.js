...
const MainNote = ( props ) => (
    ...
    <div>
        ...
        <textarea className="scroll" onChange={props.handleChange.bind( this )} id="inputTextToSave" rows="25" value={props.text} style={{ whiteSpace: "pre-wrap", fontFamily: "helvetica", fontWeight: props.fontWeight, color: "black", width: 100 + "%", backgroundColor: props.editorBackground }}>{props.text}</textarea>
